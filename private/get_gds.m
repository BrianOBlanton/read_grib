...
switch gds_struct.DRT
   ...
   case {'Spher. Harm. Coeff'} % DRT=50
      gds_struct.J=bitshift2(gds(7),gds(8));
      gds_struct.K=bitshift2(gds(9),gds(10));
      gds_struct.M=bitshift2(gds(11),gds(12));
      gds_struct.RepType=gds(13);
      gds_struct.CoefStoreMode=gds(14);
%[gds_struct.J gds_struct.K gds_struct.M gds_struct.RepType gds_struct.CoefStoreMode]
